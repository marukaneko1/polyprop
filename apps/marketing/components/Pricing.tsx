...
import { Section, SectionHeader, Card, Button, ButtonLink, Badge, Tooltip } from '@/components/ui'
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 lg:gap-3 mb-12">
        {pricingTiers.map((tier, index) => (
          ...
          >
            <Card
              className={clsx(
                'relative p-5 h-full flex flex-col transition-all duration-300 hover:scale-105 hover:border-accent/70 hover:shadow-glow-strong cursor-pointer',
