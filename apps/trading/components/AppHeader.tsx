...
import { 
  Bell, Settings, User, ChevronDown, LogOut, 
...
const mockNotifications = [
  ...
  { id: '4', type: 'success', title: 'Profit Target', message: 'You reached 50% of your profit target', time: '2 hours ago', read: true },
]
...
export function AppHeader({ 
  ...
  return (
    <header className="h-12 border-b border-border bg-surface/80 backdrop-blur-sm sticky top-0 z-50">
          ...
          <div className="relative">
            ...
            {openDropdown === 'notifications' && (
              <div className="absolute right-0 top-full mt-2 w-80 bg-[#18181b] border border-border rounded-lg shadow-xl z-50 overflow-hidden">
                  ...
                  {notifications.length === 0 ? (
                    ...
                    notifications.map(notification => (
                      <div 
                        key={notification.id} 
                        className={clsx(
                          'px-4 py-3 border-b border-border/50 last:border-0 hover:bg-surface-elevated/50 transition-colors',
                ...
                <div className="px-4 py-2 border-t border-border bg-surface-elevated/30">
                  <Link 
                    href="/notifications" 
                    className="text-xs text-accent hover:text-accent-hover"
              ...
              <div className="absolute right-0 top-full mt-2 w-64 bg-[#18181b] border border-border rounded-lg shadow-xl z-50 overflow-hidden">
                ...
                <div className="p-2">
                  ...
                  <button 
                    ...
                    className="w-full flex items-center justify-between px-3 py-2 rounded hover:bg-surface-elevated/50 transition-colors"
                  >
                  ...
                  >
                    ...
                    <div className={clsx(
                      ...
                      <div className={clsx(
                        'absolute top-0.5 w-4 h-4 rounded-full bg-white transition-transform',
                        soundEnabled ? 'left-3.5' : 'left-0.5'
                      )} />
                    </div>
                  </button>
                  ...
                  <Link 
                    href="/settings"
                    onClick={() => setOpenDropdown(null)}
                    className="w-full flex items-center gap-3 px-3 py-2 rounded hover:bg-surface-elevated/50 transition-colors"
                  >
              ...
              <div className="absolute right-0 top-full mt-2 w-64 bg-[#18181b] border border-border rounded-lg shadow-xl z-50 overflow-hidden">
                ...
                <div className="p-2">
                  ...
                  <button 
                    onClick={() => {
                      setOpenDropdown(null)
                      // In production, this would call a logout function
                      alert('Logout functionality will be implemented with authentication')
                    }}
                    className="w-full flex items-center gap-3 px-3 py-2 rounded hover:bg-error/10 transition-colors text-error"
                  >
